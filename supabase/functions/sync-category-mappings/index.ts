...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const manualMap: Record<string, string> = {
      ...
      "outdoor-panels": "panneaux-accessoires-ext",
      // Grand format
      "textile": "toiles-textiles",
      "banner": "baches-banderoles",
      "vinyl": "films-adhesifs-type",
      // Impression
      ...
      "stationery-promotional": "articles-papeterie",
