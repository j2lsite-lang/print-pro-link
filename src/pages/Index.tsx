...
const services = [
  ...
  { icon: Truck, title: "Livraison en France", desc: "Expédition suivie en France, selon le délai indiqué pour chaque produit, avec options express. Un interlocuteur dédié vous accompagne du devis à la réception de vos supports.", cta: "En savoir plus", img: imgLivraison, link: "/livraison" },
