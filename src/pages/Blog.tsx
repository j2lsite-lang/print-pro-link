...
const posts = [
  ...
  },
  {
    ...
    content: `Le flyer reste un outil de communication puissant quand il est bien conçu. Choisissez le bon **format** : A5 pour un tract généraliste, A6 ou DL pour une distribution en boîtes aux lettres. Le **grammage** recommandé est de 135g/m² pour un bon rapport qualité/prix, ou 250g/m² avec pelliculage pour un rendu premium. Côté **impression**, privilégiez le recto-verso pour maximiser votre message. J2L Print propose l'impression de flyers dans les quantités disponibles au configurateur, avec livraison partout en France. Demandez un **devis gratuit** en ligne.`,
    date: "2025-08-28",
    tag: "Conseils",
