      ...
      <div className="container max-w-3xl">
        ...
        <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
          <div className="glass-card p-6 space-y-3">
            ...
            <p><strong className="text-foreground">J2L Publicité</strong><br />22 B rue Robert Barret, 88390 Uxegney, France<br />SIRET : 508 858 784 00046 — RCS Épinal<br />TVA intracommunautaire : FR64 508 858 784<br />Tél : <a href="tel:+33329304479" className="text-primary hover:underline">03 29 30 44 79</a><br />E-mail : <a href="mailto:contact@j2lpublicite.fr" className="text-primary hover:underline">contact@j2lpublicite.fr</a></p>
